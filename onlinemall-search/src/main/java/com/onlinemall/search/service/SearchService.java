package com.onlinemall.search.service;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.github.pagehelper.PageInfo;
import com.onlinemall.item.pojo.*;
import com.onlinemall.search.client.BrandClient;
import com.onlinemall.search.client.CategoryClient;
import com.onlinemall.search.client.GoodsClient;
import com.onlinemall.search.client.SpecificationClient;
import com.onlinemall.search.pojo.Goods;
import com.onlinemall.search.pojo.SearchRequest;
import com.onlinemall.search.pojo.SearchResult;
...
public class SearchService {
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        if(params != null && params.size() >0){
            params.forEach(param -> {
                ...
                if (param.getGeneric()) {
                    // 获取通用规格参数值
                    Object o = genericSpecMap.get(param.getId());
                    String value = "";
                    if( o != null){
                        value = o.toString();
                    }
    ...
    public SearchResult search(SearchRequest request) {
        ...
        // 封装结果并返回
        return new SearchResult(goodsPage.getContent(),goodsPage.getTotalElements(),
                goodsPage.getTotalPages(), categories, brands,specs);
