...
import com.onlinemall.common.utils.IdWorker;
import com.onlinemall.order.interceptor.LoginInterceptor;
import com.onlinemall.order.mapper.OrderDetailMapper;
import com.onlinemall.order.mapper.OrderMapper;
import com.onlinemall.order.mapper.OrderStatusMapper;
import com.onlinemall.order.pojo.Order;
...
public class OrderService {
    ...
    public Order queryById(Long id) {
        ...
        List<OrderDetail> details = this.detailMapper.selectByExample(orderDetailExample);
    ...
    public PageInfo<Order> queryUserOrderList(Integer page, Integer rows, Integer status) {
        try {
            // 分页
            ...
            UserInfo user = LoginInterceptor.getLoginUser();
            // 创建查询条件
            orders = this.orderMapper.queryOrderList(user.getId(), status);
    ...
    public PageInfo<Order> queryOrderListAll(Integer page, Integer rows, String search) {
        System.out.println("-----"+search);
        PageHelper.startPage(page,rows);
        List<Order> orders = this.orderMapper.queryOrderListAll(search);
