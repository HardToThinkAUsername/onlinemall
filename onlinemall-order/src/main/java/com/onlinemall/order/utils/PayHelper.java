package com.onlinemall.order.utils;

import com.github.wxpay.sdk.WXPay;
import com.onlinemall.order.config.PayConfig;
...
public class PayHelper {
    ...
    public String createPayUrl(Long orderId) {
        ...
        try {
            ...
            //调用微信支付的终端IP（308商城的IP）
            data.put("spbill_create_ip", "127.0.0.1");
            //回调地址，付款成功后的接口
            data.put("notify_url", "http://test.onlinemall.com/wxpay/notify");
            // 交易类型为扫码支付
